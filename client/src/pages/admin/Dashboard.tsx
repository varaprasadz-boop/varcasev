...
export default function AdminDashboard() {
  ...
  const menuItems = [
    ...
    { icon: BarChart3, title: "Statistics", description: "Manage homepage stats", count: "4", href: "/admin/stats" },
    { icon: MessageSquare, title: "Form Submissions", description: "View customer inquiries", count: "0", href: "/admin/forms" },
  ];
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Welcome back, {user?.fullName}. Manage your website content below.
        </p>
      </div>
